        ...
        cmbBLZ.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent e) {
                if (e.getStateChange() == ItemEvent.SELECTED) {
                    ...
                    fill_cmbKto(cmbBLZ.getSelectedItem().toString().substring(0,
                            cmbBLZ.getSelectedItem().toString().indexOf(' ')));
                }
            }
        });
        ...
        txtDate.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent ke) {
                if (ke.getKeyCode() == KeyEvent.VK_ENTER) {
                    iKontoId = konto_id_finden(getBLZ(cmbBLZ.getSelectedItem().toString()),
                            getKto(cmbKto.getSelectedItem().toString()));
