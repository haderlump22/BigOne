...
--
-- Name: ha_kategorie_regex; Type: TABLE; Schema: public; Owner: domm
--

CREATE TABLE public.ha_kategorie_regex (
    kategorie_regex_id integer NOT NULL,
    ha_kategorie_id integer NOT NULL,
    regex_value character varying NOT NULL
);


ALTER TABLE public.ha_kategorie_regex OWNER TO domm;

--
-- Name: TABLE ha_kategorie_regex; Type: COMMENT; Schema: public; Owner: domm
--

COMMENT ON TABLE public.ha_kategorie_regex IS 'Enthält Regexinfos für Kontenereignisse zur automatisierten Festlegung von Ereignissen beim Kontoauszugimport';


--
-- Name: ha_kategorie_regex_kategorie_regex_id_seq; Type: SEQUENCE; Schema: public; Owner: domm
--

CREATE SEQUENCE public.ha_kategorie_regex_kategorie_regex_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.ha_kategorie_regex_kategorie_regex_id_seq OWNER TO domm;

--
-- Name: ha_kategorie_regex_kategorie_regex_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: domm
--

ALTER SEQUENCE public.ha_kategorie_regex_kategorie_regex_id_seq OWNED BY public.ha_kategorie_regex.kategorie_regex_id;
...
--
-- Name: kontenereignisse_regex; Type: TABLE; Schema: public; Owner: domm
--

CREATE TABLE public.kontenereignisse_regex (
    ereigniss_regex_id integer NOT NULL,
    ereigniss_id integer NOT NULL,
    regex_value character varying(100) NOT NULL
);


ALTER TABLE public.kontenereignisse_regex OWNER TO domm;

--
-- Name: TABLE kontenereignisse_regex; Type: COMMENT; Schema: public; Owner: domm
--

COMMENT ON TABLE public.kontenereignisse_regex IS 'Enthält Regexinfos für Kontenereignisse zur automatisierten Festlegung von Ereignissen beim Kontoauszugimport';


--
-- Name: kontenereignisse_regex_ereigniss_regex_id_seq; Type: SEQUENCE; Schema: public; Owner: domm
--

CREATE SEQUENCE public.kontenereignisse_regex_ereigniss_regex_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.kontenereignisse_regex_ereigniss_regex_id_seq OWNER TO domm;

--
-- Name: kontenereignisse_regex_ereigniss_regex_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: domm
--

ALTER SEQUENCE public.kontenereignisse_regex_ereigniss_regex_id_seq OWNED BY public.kontenereignisse_regex.ereigniss_regex_id;
...
--
-- Name: ha_kategorie_regex kategorie_regex_id; Type: DEFAULT; Schema: public; Owner: domm
--

ALTER TABLE ONLY public.ha_kategorie_regex ALTER COLUMN kategorie_regex_id SET DEFAULT nextval('public.ha_kategorie_regex_kategorie_regex_id_seq'::regclass);
...
--
-- Name: kontenereignisse_regex ereigniss_regex_id; Type: DEFAULT; Schema: public; Owner: domm
--

ALTER TABLE ONLY public.kontenereignisse_regex ALTER COLUMN ereigniss_regex_id SET DEFAULT nextval('public.kontenereignisse_regex_ereigniss_regex_id_seq'::regclass);
...
--
-- Name: ha_kategorie_regex ha_kategorie_regex_pkey; Type: CONSTRAINT; Schema: public; Owner: domm
--

ALTER TABLE ONLY public.ha_kategorie_regex
    ADD CONSTRAINT ha_kategorie_regex_pkey PRIMARY KEY (kategorie_regex_id);
...
--
-- Name: kontenereignisse_regex kontenereignisse_regex_pkey; Type: CONSTRAINT; Schema: public; Owner: domm
--

ALTER TABLE ONLY public.kontenereignisse_regex
    ADD CONSTRAINT kontenereignisse_regex_pkey PRIMARY KEY (ereigniss_regex_id);
